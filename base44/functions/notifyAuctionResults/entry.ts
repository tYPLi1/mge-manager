...
Deno.serve(async (req) => {
  try {
    ...
    const resultsUrl = 'https://mge002.base44.app/Leaderboard';
    ...
    fields.push({ name: '🔗 Link', value: `[View Leaderboard](${resultsUrl})`, inline: false });
    ...
    const payload = {
      ...
      components: [{ type: 1, components: [{ type: 2, label: 'View Leaderboard', style: 5, url: resultsUrl }] }],
    };
