...
export default function PlayerPowerChart({ powerHistory, currentPower }) {
  ...
  }, [powerHistory, rangeIdx, currentPower]);
  ...
  return (
    <div className="bg-[#111827] rounded-xl border border-white/5 p-4 mb-6">
      <div className="flex items-center justify-between mb-3">
        <h3 className="text-sm font-semibold text-gray-400 uppercase tracking-wider">Power History</h3>
      ...
      {chartData.length === 0 ? (
        <div className="text-center text-gray-500 text-sm py-8">No power history data</div>
      ) : (
              ...
              <ResponsiveContainer width="100%" height={200}>
                <LineChart data={chartData} margin={{ top: 5, right: 10, left: 10, bottom: 5 }}>
                  ...
                  <Tooltip
                    ...
                    formatter={(value) => [value?.toLocaleString(), "Power"]}
