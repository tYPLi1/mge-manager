...
export default function Auction() {
  ...
  if (es === "draft") return <DraftView auction={currentAuction} t={t} />;
  if (es === "closed") return <ClosedView auction={currentAuction} t={t} />;
